...
import { useCreateUser, useFinishUserOnboarding } from "@/hooks/use-user";
import { useTelegram } from "@/hooks/use-telegram";
import { RUNNING_LINE_COUNTRIES } from "@/constants/index.countries";
import { showConfirmationToast } from "@/helpers/helper.toast";
...
export default function OnBoardingPage() {
	...
	const createAppUser = useCreateUser();
	const finishOnboarding = useFinishUserOnboarding();
					...
					{count !== current ? (
						...
						<Button
							onClick={() => {
								...
								finishOnboarding.mutate({ tgUser, tonAddress });
								router.push("/esims");
							}}
							size={"bean"}
							variant={"telegram"}
