...
const BottomStickyButton = (props: Props) => {
	return (
		<>
			<div className="h-12 pt-2 safe-area-bottom w-full"></div>
			<div
				className={cn(
					"container fixed bottom-0 p-0 pt-2 w-full z-20 bg-background border-t-[1px] border-neutral-300 safe-area-bottom"
				)}
			>
				<div className="px-4">
					<Button
